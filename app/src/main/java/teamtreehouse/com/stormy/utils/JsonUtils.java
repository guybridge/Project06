...
public class JsonUtils
{
    ...
    public static Current getCurrentDetails(String jsonData) throws JSONException {
        JSONObject forecast = new JSONObject(jsonData);
        String timezone = forecast.getString("timezone");
    ...
    public static Forecast parseForecastDetails(String jsonData) throws JSONException
    {
        ...
        forecast.setCurrent(JsonUtils.getCurrentDetails(jsonData));
        forecast.setHourlyForecast(JsonUtils.getHourlyForecast(jsonData));
        forecast.setDailyForecast(JsonUtils.getDailyForecast(jsonData));
